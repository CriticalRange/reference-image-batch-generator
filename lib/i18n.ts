...
const resources = {
  en: {
    translation: {
      ...
      errorReferenceLimitNormalMode: 'Normal mode supports up to {{max}} reference images. Turn on batch mode or remove extra references.',
  ...
  tr: {
    translation: {
      ...
      errorReferenceLimitNormalMode: 'Normal mod en fazla {{max}} referans görsel destekler. Toplu modu açın veya fazla referansları kaldırın.',
