...
const SRC =
  "G:\\Ortak Drive'lar\\Ceneyra\\ÜRÜNLER\\ASIR GROUP\\260828\\TDA1205 YUKA TV DUVARA MONTAJ\\TDA1205AT5.jpg";
const DEST_DIR =
  "G:\\Ortak Drive'lar\\Ceneyra\\ÜRÜNLER\\ASIR GROUP\\260828\\TDA1205 YUKA TV DUVARA MONTAJ";
const BASE = 'http://localhost:3000';

const prompt =
  'The attached image is a studio cutout of a wall-mounted TV cabinet on white. Ignore where it sits on the white canvas. Keep the manufactured product identical: anthracite/dark-grey body, top and sides; two travertine/cream stone-laminate doors with a 3x3 grid of laser-engraved rectangles inside a double rectangular frame; each door has one square black knob in the centre. The laser grid lines are dark/black engraved grooves ON the travertine — not gold, not silver, not plexiglass, not raised. No decorative plexiglass. Doors CLOSED. Place it in a photoreal living room as duvara monte. HANG HIGH: mid-wall with a thick empty wall band under the cabinet at least as tall as the cabinet body, then skirting, then a deep floor. No bench or plinth under it. TV on the wall above is fully in frame and black/off. Camera: three-quarter view from the left, product clearly readable. 2:3 portrait catalogue photo.';
...
const outPath = path.join(DEST_DIR, 'TDA1205AT2.jpg');
if (item.blobUrl) {
